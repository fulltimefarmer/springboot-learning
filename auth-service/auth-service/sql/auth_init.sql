...
-- OKTA for dev
INSERT INTO okta (id,app_name,client_id,owner,status,secret,redirect_url,custom_scopes,application_type,grant_types,project_id,`describe`) VALUES 
(1,'cig login','nike.gcsc.cig','gcsc','Approved','wMySGICc4LtWawQXu9uc2IdLKOK5NHz9IshqgtTQYVAfEG9r0K4Hqw8K30a_KPwZ','http://localhost:3000/implicit/callback','Implicit;Refresh Token;Authorization Code','web',NULL,4,NULL);
-- OKTA for prod
/**
INSERT INTO okta (id,app_name,client_id,owner,status,secret,redirect_url,custom_scopes,application_type,grant_types,project_id,`describe`) VALUES 
(1,'cig login','nike.gcsc.cig','gcsc','Approved','uDSNEhG2ztDnHyIEbMbwlqQAv8Kcq2RQC4gsXOe65bKuGjhj5fqfOTew7Fn4XaW2','https://cig.nike.com/implicit/callback','Implicit;Refresh Token;Authorization Code','web',NULL,4,NULL);
**/
